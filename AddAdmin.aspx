...
<div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
<div class="html_content"><p style="text-align:Center;"><span style="font-family:'Roboto Slab','Arial';background-color:orange;font-weight:700;font-size:2.571em;color:black;">ADD ANOTHER ADMINS DETAILS </span></p></div>
<div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
...
<div class="html_content"><p><span style="font-family:'Roboto Slab','Arial';font-weight:700;font-size:1.714em;color:rgba(34,34,34,1);">Add&nbsp; Details</span></p><p style="margin:1.43em 0em 0.36em 0em;"/>
    
    <form  id="ContactForm0" class="form-horizontal" role="form" method="post"  style="padding:0px 0px 0px 0px;float:left;">
        <div class="form-group">
        
        <label class="col-sm-4 control-label">Full Name</label><div class="col-sm-8">
...
<asp:requiredfieldvalidator ForeColor="Red" id="Requiredfieldvalidator2" runat="server" errormessage="Please Enter Mobile Number" controltovalidate="textmobile"></asp:requiredfieldvalidator>
             ...
             <div class="col-sm-8">
                 ...
                 <div class="col-sm-4 col-sm-offset-8">
                     ...
                     <asp:Button ID="btnsignup" runat="server" OnClick="btnsignup_Click" Text="Add For Admin" CssClass="pull-right btn btn-sm btn-primary"/>
