...
<li class="ttr_menu_items_parent dropdown active"><a href="ContactUs.aspx" class="ttr_menu_items_parent_link_active" style="color:orange"><span class="menuchildicon"></span>Contact</a>
<hr class ="horiz_separator"/>
</li>
</ul>
</div>
...
<div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
<div class="html_content"><p style="text-align:Center;"><span style="font-family:'Roboto Slab','Arial';background-color:orange;font-weight:700;font-size:2.571em;color:black;">CONTACT US</span></p></div>
<div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
...
<div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
<div class="html_content"><p><span style="font-family:'Roboto Slab','Arial';font-weight:700;font-size:1.714em;color:rgba(34,34,34,1);">Contact Form</span></p><p style="margin:1.43em 0em 0.36em 0em;"/>
    
    <form id="ContactForm0" class="form-horizontal" role="form" method="post"  style="padding:0px 0px 0px 0px;float:left;">
        <div class="form-group">
        
        <label class="col-sm-4 control-label">Name</label><div class="col-sm-8">
     ...
     <asp:TextBox ID="txtemail" runat="server" TextMode="Email"   placeholder="Email" CssClass="form-control"></asp:TextBox>
        ...
        <div class="form-group">
         ...
         <div class="col-sm-8">
             ...
             <asp:TextBox ID="textmobile" placeholder="Mobile Number" TextMode="Number" runat="server"  CssClass="form-control"></asp:TextBox>
      <br /></div></div>
             <div class="form-group">
         ...
         <div class="col-sm-8">
             ...
             <asp:TextBox ID="textsubject" placeholder="Subject" runat="server"  CssClass="form-control"></asp:TextBox>
      <br />
             
         </div></div><div class="form-group"><label class="col-sm-4 control-label">Message</label>
             <div class="col-sm-8">
                 
                 <asp:TextBox TextMode="MultiLine" ID="txtmessage" placeholder="Enter Your Query Here" runat="server" CssClass="form-control comment"></asp:TextBox> 
                  <asp:RegularExpressionValidator ID="validpass" runat="server" ErrorMessage="Paragraph Must be Betwwen 100 to 500 Charactrers"
                 ...
                 <div class="col-sm-4 col-sm-offset-8">
                     ...
                     <asp:Button ID="btnadd" runat="server" OnClick="btnadd_Click" Text="Send message" CssClass="pull-right btn btn-sm btn-primary"/>
                    
            
 
                        </div></div><div class="clearfix"></div><div class="success"></div><div class="req_field"></div>
...
<div clas
    ...
    s="ttr_Contact_html_column02">
<div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
<div class="html_content"><p><span style="font-family:'Roboto Slab','Arial';font-weight:700;font-size:1.714em;color:rgba(34,34,34,1);">Contact Info</span></p><p style="margin:1.43em 0em 0.36em 0em;line-height:1.54929577464789;"><span style="font-family:'Roboto','Arial';font-weight:300;font-size:1.143em;color:rgba(34,34,34,1);">Lovely Professional University is a semi-residential university college in North India created under the Punjab State Private University Act 2005 and recognized by UGC under Section 2 of UGC Act 1956.</span></p><p style="margin:1.43em 0em 0em 0em;line-height:1.54929577464789;"><span style="font-family:'Roboto','Arial';font-weight:500;font-size:1.143em;color:rgba(34,34,34,1);">Jalandhar-Delhi G.T. Road, National Highway 1</span></p><p style="margin:0em 0em 0em 0em;line-height:1.54929577464789;"><span style="font-family:'Roboto','Arial';font-weight:500;font-size:1.143em;color:rgba(34,34,34,1);">Phagwara, Punjab 144411</span></p><p style="margin:1.43em 0em 0.36em 0em;line-height:1.54929577464789;"><span style="font-family:'Roboto','Arial';font-weight:500;font-size:1.143em;color:rgba(34,34,34,1);">Phone No :- 1800 102 4431<br />
Tel: +91-1824-404404</span></p><p style="margin:0em 0em 0.36em 0em;line-height:1.54929577464789;"><span style="font-family:'Roboto','Arial';font-weight:500;font-size:1.143em;color:rgba(34,34,34,1);">Founder: Baldev Raj Mittal</span></p><p style="margin:0em 0em 0.36em 0em;line-height:1.54929577464789;"><span style="font-family:'Roboto','Arial';font-weight:500;font-size:1.143em;color:rgba(34,34,34,1);">Email :- info@lpu.co.in</span></p><p style="margin:0em 0em 0.36em 0em;line-height:1.54929577464789;"><br style="font-family:'Roboto','Arial';font-weight:500;font-size:1.143em;color:rgba(34,34,34,1);" /></p></div>
<div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
<div style="clear:both;"></div>
</div>
</div>
