r<%@ Page Language="C#" AutoEventWireup="true" CodeFile="registration2.aspx.cs" Inherits="registration2" %>
...
<div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
<div class="html_content"><p style="text-align:Center;"><span style="font-family:'Roboto Slab','Arial';background-color:orange;font-weight:700;font-size:2.571em;color:black;">CREATE ACCOUNT</span></p></div>
<div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
...
<div class="html_content"><p><span style="font-family:'Roboto Slab','Arial';font-weight:700;font-size:1.714em;color:rgba(34,34,34,1);">Sign Up</span></p><p style="margin:1.43em 0em 0.36em 0em;"/>
    
    <form  id="ContactForm0" class="form-horizontal" role="form" method="post"  style="padding:0px 0px 0px 0px;float:left;">
        <div class="form-group">
        
        <labFull Name</label><div class="col-sm-8">
          
   <asp:TextBox ID="txtname" Width="310px" runat="server" style="margin-left:40px" placeholder="Name" Cssclass="form-control"></asp:TextBox>
            <asp:requiredfieldvalidator ForeColor="Red" id="Requiredfieldvalidator1" runat="server" errormessage="Please Enter Name" controltovalidate="txtname"></asp:requiredfieldvalidator>
              <br />
            <br />
     ...
     <asp:TextBox ID="txtemail"  Width="310px" runat="server" style="margin-left:40px" TextMode="Email"  placeholder="Email" CssClass="form-control"></asp:TextBox>
            <asp:requiredfieldvalidator ForeColor="Red" id="r1" runat="server" errormessage="Please Enter Email" controltovalidate="txtemail"></asp:requiredfieldvalidator>
              <br /><br />
        ...
        <div class="form-group">
         ...
         <div class="col-sm-8">
             ...
             <asp:TextBox ID="textmobile" style="margin-left:40px" Width="310px" placeholder="Mobile Number" TextMode="Number"  runat="server"  CssClass="form-control"></asp:TextBox>
<asp:requiredfieldvalidator ForeColor="Red" id="Requiredfieldvalidator2" runat="server" errormessage="Please Enter Mobile Number" controltovalidate="textmobile"></asp:requiredfieldvalidator>
              <br />     
              <br /></div></div>
             <div class="form-group">
         ...
         <div class="col-sm-8">
             ...
             <asp:TextBox style="margin-left:40px" Text="" ID="textcountry" Width="310px" placeholder="Country" runat="server"  CssClass="form-control"></asp:TextBox>
      <asp:requiredfieldvalidator ForeColor="Red" id="Requiredfieldvalidator3" runat="server" errormessage="Please Enter Country" controltovalidate="textcountry"></asp:requiredfieldvalidator>
              <br />
             <br />
             
         </div></div><div class="form-group"><label class="col-sm-4 control-label">Password</label>
             <div class="col-sm-8">
                 
                 <asp:TextBox style="margin-left:40px" Width="310px"  ID="txtpassword" TextMode="Password" placeholder="Password" runat="server" CssClass="form-control comment"></asp:TextBox> 
                  <asp:RegularExpressionValidator ID="validpass" runat="server" ErrorMessage="Password must contain: Atleast 1 letter, 1 number, 1 special character and SHOULD NOT start with a special character"
                        ControlToValidate="txtpassword"
                   ValidationExpression="^(?=.*[a-zA-Z])(?=.*\d)(?=.*[!@#$%^&*()_+])[A-Za-z\d][A-Za-z\d!@#$%^&*()_+]{7,19}$"></asp:RegularExpressionValidator>
                 <br />
                 <br />
             </div></div><div class="form-group">
                 <div class="col-sm-4 col-sm-offset-8">
                    
                     <asp:Button ID="btnsignup" runat="server" OnClick="btnsignup_Click" Text="Sign Up" CssClass="pull-right btn btn-sm btn-primary"/>
