...
public partial class AdminSigninPannel : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string v = Request.QueryString["value"];
        username.Text = "Welcome Mr.Akhil Pathania"; 
        ...
        conn.Open();
        string strSQL = "SELECT fullname FROM signup WHERE email='" + v + "'";
